...
async function browserChrome() {
  ...
  try {
    ...
    await driver.findElement(By.id('OutputButton')).click();
    let vtest = await driver.findElement(By.id('OutputButton')).getAttribute('class');
    ...
    assert.strictEqual(vtest, 'A: test');
