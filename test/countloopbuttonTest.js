...
async function browserChrome() {
  ...
  try {
    ...
    await driver.findElement(By.id('CountLoopButton')).click();
    let vtest = await driver.findElement(By.id('CountLoopButton')).getAttribute('class');
    ...
    await driver.findElement(By.xpath('/html/body/main/div[1]/div[4]/div[1]/div[1]/div[1]/div/div[1]/div[2]/div[2]')).click();
