...
async function browserChrome() {
  ...
  try {
    ...
    let vtest = await driver.findElement(By.id('FootLoopButton')).getAttribute('class');
    ...
    await driver.findElement(By.xpath('/html/body/main/div[1]/div[4]/div[1]/div[1]/div[1]/div/div[2]/div[1]/div[2]/input')).sendKeys('test' + Key.RETURN);
    vtest = await driver.findElement(By.xpath('/html/body/main/div[1]/div[4]/div[1]/div[1]/div[1]/div/div[2]/div[1]/div[1]/span')).getText();
